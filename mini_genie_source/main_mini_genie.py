...
def call_genie(run_time_settings, arg_parser_values):
    ...
    if arg_parser_values.genie_pick or run_time_settings["Simulation_Settings"]["run_mode"] == "genie_pick":
    ...
    #
    elif arg_parser_values.user_pick or run_time_settings["Simulation_Settings"]["run_mode"] == "user_pick":
