...
Run_Time_Settings = dict(
    ...
    Simulation_Settings=dict(
        study_name='rlgl_ETHUSD_66M',
        optimization_period=dict(
            start_date=datetime.datetime(month=2, day=10, year=2022),
            end_date=datetime.datetime(month=6, day=10, year=2022)
            # start_date=datetime.datetime(month=1, day=1, year=2022),
            # end_date=datetime.datetime(month=5, day=30, year=2022)
        ),
        #
    ...
    Strategy_Settings=dict(
        ...
        parameter_windows=dict(
            rsi_timeframes=dict(type='timeframe', values=['1 min', '5 min', '15 min', '30 min', '1h', '4h']),
